...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE \"Parcours\" (\"id\" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL , \"cimena\" VARCHAR NOT NULL , \"restaurant\" VARCHAR NOT NULL , \"accompagnent\" VARCHAR NOT NULL ); ");
